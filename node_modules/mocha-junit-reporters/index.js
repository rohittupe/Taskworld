...
var debug = require("debug")("mocha-junit-reporters");
...
function updateOptionsForJenkinsMode(options) {
  ...
  debug(
    "jenkins mode - testCaseSwitchClassnameAndName",
...
MochaJUnitReporter.prototype.getTestcaseData = function(test, err) {
  ...
  var name = stripAnsi(
    jenkinsMode ? getJenkinsClassname(test) : test.fullTitle()
  );
  ...
  if (
    ...
    (test.consoleOutputs && test.consoleOutputs.length > 0)
  ) {
